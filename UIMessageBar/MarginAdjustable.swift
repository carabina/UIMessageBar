...
/*
 ...
 `layoutMargins` adjusted by UIMessageBar to account for the height of the
 status bar (when displayed under the status bar) and a small amount of
 overshoot in the bounce animation. `UIMessageView` implements this protocol
 by way of its parent class `UIMessageBaseView`.
