//
//  UIMessagePhysicsAnimation.swift
//  UIMessageBar
//
//  Created by Elias Abel on 6/14/16.
//  Copyright © 2016 Meniny. All rights reserved.
//

import UIKit

public class UIMessagePhysicsAnimation: NSObject, Animator {
    ...
    var panHandler: UIMessagePhysicsPanHandler?

    func installInteractive(context: AnimationContext) {
        guard context.interactiveHide else { return }
        panHandler = UIMessagePhysicsPanHandler(context: context, animator: self)
    }
}
